    ...
    props: mergeProps<"div">(
      {
        ...
        ref,
        className: cn(
          "relative flex items-center rounded-md p-2 data-[state=active]:bg-muted",
          orientation === "horizontal"
            ? "flex-row"
    ...
    props: mergeProps<"span">(
      {
        ...
        dir: context.dir,
        ref,
        className: cn("font-medium text-sm leading-6", className),
      },
      titleProps,
    ),
    render,
